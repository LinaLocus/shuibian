...
1. 打开 [https://console.neon.tech，用](https://console.neon.tech，用) GitHub 账号登录
...
1. 打开 [https://render.com，用](https://render.com，用) GitHub 登录
2. 右上角 **New +** → **Blueprint**
...
- **冷启动**：15 分钟无访问后，后端会休眠。下次访问要等 30-60 秒（前端是静态站不受影响）
  - 解法：用 [https://uptimerobot.com](https://uptimerobot.com) 每 5 分钟 ping 一次 `https://shuibian-api.onrender.com/api/auth/me`，能保持后端常活
...
访问 [http://localhost:5173，本地用本地数据库，公网用](http://localhost:5173，本地用本地数据库，公网用) Neon，两套环境完全独立。
